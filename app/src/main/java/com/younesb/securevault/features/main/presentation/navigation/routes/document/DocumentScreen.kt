...
fun DocumentScreen(
    ...
    LaunchedEffect(file) {
        if ((file is Resource.Success) and (document.getOrNull()?.type == DocumentType.NOTE)) {
                ...
                TwoRowsTopAppBar(
                    title = {
                        Text(
                            text = doc.name,
                            style =
                                if (it) MaterialTheme.typography.headlineLarge
                    ...
                    subtitle = {
                        if (it) {
                            ...
                            Text(
                                text = stringResource(
                                    R.string.created,
                                    doc.createdAt.toReadableDateString()
                                ),
                            )
                        }
                    },
                ...
                LazyColumn(
                    ...
                    item {
                        InfoElement(
                            ...
                            text = doc.createdAt.toReadableDateString(),
                            index = 2,
                            count = 3
                        )
                    }
